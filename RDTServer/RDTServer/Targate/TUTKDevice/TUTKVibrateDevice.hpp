...
#ifndef __RDTServer__TUTKVibrateDevice__
#define __RDTServer__TUTKVibrateDevice__

#include <stdio.h>
#include "Device.hpp"

class TUTKVibrateDevice : public Device
{
public:
...
#endif /* defined(__RDTServer__TUTKVibrateDevice__) */
