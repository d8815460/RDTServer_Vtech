...
void BinraryRDTClientCommand::sendReportAllWithCommand30(int channelID, vector<FunctionInfo*>* pFunctionInfoList)
{
    int count = 0;
...
void BinraryRDTClientCommand::sendReportWithCommand30(int channelID, vector<FunctionInfo*>* pFunctionInfoList)
{
    // 傳送的資料Buffer
    int sendIndex = 0;
    BYTE sendDataBuffer[MAX_BUFFER_SIZE];
...
void BinraryRDTClientCommand::sendReportAllWithCommand32(int channelID, int operations, int aid, unsigned int type, int status)
{
    int count = 0;
    for (set<int>::iterator it = m_nChannelIDList.begin() ; it != m_nChannelIDList.end() ; it++) {
        int myChannelID = *it;
...
void BinraryRDTClientCommand::sendReportAllWithCommand32(int channelID, int operations, int amount, int aids[], unsigned int types[], int statuses[])
{
    int count = 0;
    for (set<int>::iterator it = m_nChannelIDList.begin() ; it != m_nChannelIDList.end() ; it++) {
        int myChannelID = *it;
...
void BinraryRDTClientCommand::sendReportWithCommand32(int channelID, int operations, int amount, int aids[], unsigned int types[], int statuses[])
{
    // 傳送的資料Buffer
    int sendIndex = 0;
    BYTE sendDataBuffer[MAX_BUFFER_SIZE];
...
void BinraryRDTClientCommand::sendReportAllWithCommand33(int channelID, int operations, int status)
{
    int count = 0;
    for (set<int>::iterator it = m_nChannelIDList.begin() ; it != m_nChannelIDList.end() ; it++) {
        int myChannelID = *it;
...
void BinraryRDTClientCommand::sendReportWithCommand33(int channelID, int operations, int status)
{
    // 傳送的資料Buffer
    int sendIndex = 0;
    BYTE sendDataBuffer[MAX_BUFFER_SIZE];
