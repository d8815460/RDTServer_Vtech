...
#ifndef __RDTServer__TUTKSirenDevice__
#define __RDTServer__TUTKSirenDevice__

#include <stdio.h>
#include "Device.hpp"

class TUTKSirenDevice : public Device
{
public:
...
#endif /* defined(__RDTServer__TUTKSirenDevice__) */
